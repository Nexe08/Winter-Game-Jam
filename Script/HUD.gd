...
func _ready() -> void:
    ...
    # warning-ignore:return_value_discarded
    Global.connect("bomb_count_updated", self, "_handel_bomb_count_visual")
...
func _handel_bomb_count_visual(value) -> void:
    $MC/HBoxContainer/BombCount/Label.text = String(value)
